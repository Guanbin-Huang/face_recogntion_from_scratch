...
# 此处加的是为了第一步的人脸crop
    ...
    crop_img.save(fr"D:\pycharmproject\FaceRecognizition\yolov5-face-master\data\crop_img\lyf01.jpg")
...
if __name__ == '__main__':
    ...
    parser.add_argument('--image', type=str, default='data/images/02.jpg', help='source')  # file/folder, 0 for webcam
